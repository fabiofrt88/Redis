...
public class UserJPA {
    ...
    public UserJPA(Long id, String firstName, String lastName, String profilePicture, String email, String passwordEncrypted, String domicileAddress, String domicileCity, String domicileNumber, String domicileState, String fiscalCode) {
        this.id = id;
